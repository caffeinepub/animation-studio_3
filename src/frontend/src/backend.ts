...
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<void> {
    ...
    async loadProject(arg0: string): Promise<Project> {
        if (this.processError) {
            try {
    ...
    async saveProject(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: Array<Frame>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProject(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
